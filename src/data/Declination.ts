...
export const words: TDeclination[] = [
  ...
  w('on sam', 'pronomia', ['ipse', 'ipsius', 'ipsi', 'ipsum', 'ipso'], ['ipsi', 'ipsorum', 'ipsis', 'ipsos']),
  w('ona sama', 'pronomia', ['ipsa', 'ipsius', 'ipsi', 'ipsam', 'ipsa'], ['ipsae', 'ipsarum', 'ipsis', 'ipsas']),
  w('ono samo', 'pronomia', ['ipsum', 'ipsius', 'ipsi', 'ipsum', 'ipso'], ['ipsa', 'ipsorum', 'ipsis']),
  ...
  w('sama', 'verba irregulara', ['sola', 'solius', 'soli', 'solam', 'sola'], ['solae', 'solarum', 'solis', 'solas']),
