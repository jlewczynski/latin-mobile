...
export const words: TDeclination[] = [
  ...
  w('ten sam', 'pronomia', ['ipse', 'ipsius', 'ipsi', 'ipsum', 'ipso'], ['ipsi', 'ipsorum', 'ipsis', 'ipsos']),
  w('ta sama', 'pronomia', ['ipsa', 'ipsius', 'ipsi', 'ipsam', 'ipsa'], ['ipsae', 'ipsarum', 'ipsis', 'ipsas']),
  w('to samo', 'pronomia', ['ipsum', 'ipsius', 'ipsi', 'ipsum', 'ipso'], ['ipsa', 'ipsorum', 'ipsis']),
